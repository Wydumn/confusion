...
function Header({ logoutUser, loginUser, auth }) {
              ...
              <Nav navbar>
                ...
                <NavItem>
                  <NavLink className="nav-link" to="/favorites">
                    <span className="fa fa-heart fa-lg">My Favorites</span>
                  </NavLink>
                </NavItem>
                <NavItem>
       ...
       <Modal isOpen={isModalOpen} toggle={toggleModal}>
         ...
         <ModalBody>
          <Form onSubmit={handleLogin}>
            ...
            <FormGroup check>
              <Label check>
                <Input type="checkbox" name="remember" innerRef={(input) => setRemember(input)} />
                Remember me
              </Label>
            </FormGroup>
